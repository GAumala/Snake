...
void init(void)
{
    ...
    fruit_surface = SDL_LoadBMP("images/apple.bmp");
    shead_surface = SDL_LoadBMP("images/head.bmp");
    snake_surface = SDL_LoadBMP("images/snake.bmp");
    field_surface = SDL_LoadBMP("images/field.bmp");
